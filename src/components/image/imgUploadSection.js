...
const ImgUpload = ({ selectedFiles, setSelectedFiles }) => {
    ...
    return (
        <div className={`transition-all duration-300 flex flex-col-reverse xl:flex-col`}>
            ...
            <div className='relative h-[200px] md:h-[300px] lg:h-[350px] xl:h-[380px] w-[clamp(350px,90vw,500px)] xl:w-[600px] rounded-xl overflow-y-auto scrollbar-none border border-dashed border-gray-600 flex items-center justify-center flex-wrap transition-all duration-300'>
